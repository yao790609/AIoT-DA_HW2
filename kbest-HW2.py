...
# 篩選出重要特徵
X_selected = X[X.columns[kbest.get_support()]]
...
X_test_selected = pd.DataFrame(X_test_scaled, columns=X.columns)[X.columns[kbest.get_support()]]
...
output.to_csv( r'C:\Users\User\Downloads\titanic_predictions_kbest.csv', index=False)
